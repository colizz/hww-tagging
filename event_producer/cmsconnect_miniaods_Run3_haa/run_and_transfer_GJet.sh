...
find ./fragments -type f -name 'GJet*' -exec sed -i 's/13000/13600/g' {} +
...
xrdcp -f root://eosuser.cern.ch//eos/user/c/chpan/custom_cmssw_strict/PythiaHepMCFilterGammaGamma.cc $CMSSW_BASE/src/GeneratorInterface/Core/src/
