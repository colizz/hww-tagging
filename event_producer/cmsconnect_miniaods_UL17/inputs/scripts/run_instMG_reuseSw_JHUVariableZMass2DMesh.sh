...
python $INPUTDIR/scripts/lhe_modifier.py -m switch -i $WORKDIR/cmsgrid_final.lhe -o $WORKDIR/cmsgrid_final_s.lhe
...
python $INPUTDIR/scripts/lhe_modifier.py -m switch -i $WORKDIR/cmsgrid_final_s_jhu.lhe -o $WORKDIR/cmsgrid_final_s_jhu_s.lhe
...
# 5. correct the LHE
python $INPUTDIR/scripts/lhe_modifier.py -m correct -i $WORKDIR/cmsgrid_final_s_jhu_s_jhu.lhe -o $WORKDIR/cmsgrid_final_s_jhu_s_jhu_c.lhe
