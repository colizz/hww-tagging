    ...
    return cms.PSet(
        ...
        PythiaParameters = cms.PSet(
            ...
            processParameters = cms.vstring(
                '25:onMode = off',
                '25:oneChannel = 1 1.000000 100 22 22', # H -> gamma gamma
...
for mh in low_m_higgs:
    for mx in low_m_res:
        # print('BulkGravitonToHH_MX%.0f_MH%.0f weight 1.0' % (mx, mh))
        generator.RandomizedParameters.append(pset(mx, mh, 1.0))
