    ...
    return cms.PSet(
        ...
        PythiaParameters = cms.PSet(
            ...
            processParameters = cms.vstring(
                '25:onMode = off',
                '25:oneChannel = 1 1.000000 100 -3 5', # H -> b s
            ),
...
for mh in low_m_higgs:
    ...
    # for mx in low_m_res:
    #     print('BulkGravitonToHH_HToBS_MX%.0f_MH%.0f weight %.4f' % (mx, mh, weight))
    ...
    for mx in mres_lowpt_points(mh, n=len(low_m_res)):
        print('BulkGravitonToHH_HToBS_MX%.0f_MH%.0f weight %.4f' % (mx, mh, 0.5*weight))
