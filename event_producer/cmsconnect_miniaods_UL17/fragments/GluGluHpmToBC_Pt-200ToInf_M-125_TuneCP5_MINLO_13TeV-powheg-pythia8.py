...
externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    ...
    scriptName = cms.FileInPath('Configuration/GenProduction/data/run_generic_tarball_cvmfs_modify_lhe_ggh.sh') ## customized script to modify the LHE file (Higgs -> Hpm)
)
...
generator = cms.EDFilter("Pythia8ConcurrentHadronizerFilter",
        ...
        processParameters = cms.vstring(
            ...
            '37:m0 = 125.0',
            '37:onMode = off',
            '37:oneChannel = 1 1.00000 100 -5 4', ## force to Hpm To BC decay 
          ),
